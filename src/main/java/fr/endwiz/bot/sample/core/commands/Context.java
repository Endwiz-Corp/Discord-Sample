...
import fr.endwiz.bot.sample.utils.StringUtils;
...
public class Context {
    ...
    public CmdPermission getPermissions() {
        if (this.getAuthorId().equals(Main.getOwnerId())) {
            return CmdPermission.OWNER;
            ...
            return CmdPermission.ADMIN;
        }

        return CmdPermission.USER;
    }
